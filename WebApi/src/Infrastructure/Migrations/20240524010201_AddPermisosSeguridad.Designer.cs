...
namespace WebApi.Infrastructure.Migrations
{
    ...
    [Migration("20240524010201_AddPermisosSeguridad")]
    partial class AddPermisosSeguridad
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApi.Domain.Entities.Control", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("WebApi.Domain.Entities.Licencia", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("WebApi.Domain.Entities.PermisoSeguridad", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");

                    b.Property<bool>("Calendario")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("Carreras")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<bool>("PeriodosAcademicos")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("Reportes")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("UsuariosSistema")
                        .HasColumnType("tinyint(1)");

                    b.HasKey("Id");

                    b.ToTable("PermisoSeguridades");
                });
            ...
            modelBuilder.Entity("WebApi.Domain.Entities.UsuarioInformacion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("UsuarioInformaciones");
                });
            ...
            modelBuilder.Entity("WebApi.Domain.Entities.UsuarioInformacion", b =>
                {
                    b.HasOne("WebApi.Domain.Entities.PermisoSeguridad", "Permiso")
                        .WithMany("Usuarios")
