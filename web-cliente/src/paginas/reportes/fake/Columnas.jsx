...
const Column = () => {
    ...
    return (<div className='control-pane'>
        ...
        }} load={load.bind(this)} enableRotation={true} rotation={7} tilt={10} depth={100} tooltip={{ enable: true, header: "${point.x}", format: 'Sales Count : <b>${point.y}' }} width={Browser.isDevice ? '100%' : '75%'}
